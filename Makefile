...
TOPLEVEL_CONFIGURE_ARGUMENTS=./configure --prefix=/home/nn/stow/gdb
...
BUILD_CONFIGARGS =  --cache-file=./config.cache '--prefix=/home/nn/stow/gdb' --program-transform-name='s,y,y,' --disable-option-checking --disable-year2038 --with-build-subdir="$(BUILD_SUBDIR)"
...
SUBDIRS =  intl libiberty opcodes bfd zlib libctf libsframe binutils gas ld gprof etc gprofng
TARGET_CONFIGDIRS = 
# This is set by the configure script to the arguments to use when configuring
# directories built for the host system.
HOST_CONFIGARGS =  --cache-file=./config.cache  --with-gnu-as --with-gnu-ld '--prefix=/home/nn/stow/gdb' --program-transform-name='s,y,y,' --disable-option-checking --disable-year2038
...
TARGET_CONFIGARGS = --cache-file=./config.cache --enable-multilib   '--prefix=/home/nn/stow/gdb' --program-transform-name='s,y,y,' --disable-option-checking --disable-year2038 --with-target-subdir="$(TARGET_SUBDIR)"
# This is the list of variables to export in the environment when
...
AS = as
AR = ar --plugin /usr/lib/gcc/x86_64-linux-gnu/12/liblto_plugin.so
AR_FLAGS = rc
CC = gcc
CXX = g++
DLLTOOL = dlltool
...
OBJDUMP = objdump
OTOOL = otool
RANLIB = ranlib --plugin /usr/lib/gcc/x86_64-linux-gnu/12/liblto_plugin.so
READELF = readelf
STRIP = strip
WINDRES = windres
WINDMC = windmc
